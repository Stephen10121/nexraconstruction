...
<div class="overflow-x-hidden">
                    ...
                    >
                        <div use:motion>
                            ...
                            <h1 class="text-5xl md:text-7xl font-black text-white leading-none mb-6 max-w-3xl">
                                Built Right.
                                <br />
                                <span style="color: #f68318">
                                    Every Time.
                                </span>
                            </h1>
                            <p class="text-lg md:text-xl text-white/70 mb-10 max-w-xl leading-relaxed">
                                NEXRA Construction delivers exceptional
                                craftsmanship for residential and commercial
        ...
        <section class="py-24 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <FadeUp delay={0.15}>
                ...
                <p class="text-gray-600 leading-relaxed mb-4">
                    Tim Muklanovich founded NEXRA Construction with a simple
                    belief: every homeowner deserves a contractor who shows
                    up, communicates clearly, and delivers exactly what was
                    promised.
                </p>
                <p class="text-gray-600 leading-relaxed mb-8">
                    With over 15 years of hands-on experience across Clark
                    County, we've built a reputation on reliability,
                    precision, and work that stands the test of time.
                </p>
                <ul class="space-y-3 mb-8">
                    {#each [
                        "Licensed & Bonded in Washington State",
                        "Detailed written estimates — no hidden costs",
                        "We answer our phones and return calls",
                        "Job-site cleanup every single day",
                    ] as item (item)}
                        <li
                        ...
                        >
                            <CheckCircle2
                                size={18}
                                style="color: #f68318;flex-shrink: 0;"
                            />
                            {item}
                        </li>
                    {/each}
                        ...
                        <FadeUp delay={i * 0.07}>
                            ...
                            >
                                ...
                                <div class="absolute inset-0 flex flex-col justify-end p-6">
                                    ...
                                    >
                                    <p
                                        class="text-white/70 text-sm leading-relaxed overflow-hidden"
                                        use:motion
                                    >
                                        {service.desc}
                                    </p>
        ...
        >
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                    <div
                        class="hidden md:block absolute top-12 left-1/3 right-1/3 h-px bg-[#f68318]"
                        style="opacity: 0.3;"
                    ></div>
                    ...
                    {#each [
                        {
                            ...
                            desc: "We visit your property, listen carefully to your vision, and walk you through realistic options and pricing — no pressure, no obligation.",
                        },
                        {
                            step: "02",
                            title: "Detailed Proposal",
                            desc: "Receive a clear, itemized written estimate with timeline, materials, and scope of work. What you see is what you pay.",
                        },
                        {
                            step: "03",
                            title: "Expert Execution",
                            desc: "Our skilled team gets to work with daily communication, site cleanup, and a final walkthrough to make sure you love every detail.",
                        },
                    ] as step, i (step.step)}
                        <FadeUp delay={i * 0.15}>
                            <div class="text-center">
                                ...
                                >
                                    <div
                                        class="absolute inset-0 opacity-10 bg-[#f68318]"
                                    ></div>
                                    {step.step}
                                </div>
                ...
                {#each [
                    {
                        ...
                        desc: "WA State License #NEXRACO123",
                    },
                    {
                        icon: Clock,
                    ...
                    },
                    {
                        ...
                        desc: "Deep local expertise",
                    },
                    {
                        icon: Star,
                        title: "5-Star Rated",
                        desc: "Google & Houzz verified",
                    },
                ] as badge, i (badge.title)}
                    <FadeUp delay={i * 0.08}>
                        <div class="text-center">
                            <badge.icon
                                class="mx-auto mb-3"
        ...
        <section class="relative py-28 px-6 overflow-hidden">
            ...
            <div
                class="absolute inset-0"
                style="background-color: rgba(20,28,38,0.88)"
            ></div>
            <div class="relative z-10 max-w-3xl mx-auto text-center">
                <FadeUp>
                    ...
                    <p class="text-white/70 text-lg mb-10 leading-relaxed">
                        Get a free, no-obligation estimate from Clark
                        County's most trusted general contractor. Tim picks
                        up the phone.
                    </p>
